/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc44993b011af84f5c327db27a1bcdcd)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SNAPSHOT_SOURCE">> {}
}
